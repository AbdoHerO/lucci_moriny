$("#formInfo").submit(function (event) {
  ...
  var serviceType = $('#formInfo select[name="service_type"]').val();
  ...
  var sheetDBData = {
    ...
    quantity: "1",
    price: "---- MAD",
    product_notice: 'Service :' +serviceType,
    notice: "",
    status: "pending",
    fees_shipping: "",
  };
  ...
  fetch("https://sheetdb.io/api/v1/7fx0hvcoif8ln", {
    ...
    .then(function (response) {
      ...
      if (response.ok) {
        ...
        const whatsappUrl = `https://api.whatsapp.com/send?phone=+212612167742&text=${encodeURIComponent(whatsappMessage)}`;
