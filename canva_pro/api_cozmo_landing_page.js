$("#formInfo").submit(function (event) {
  ...
  var question = $('#formInfo select[name="question"]').val();
  var pack = $('#formInfo select[name="pack"]').val();
  ...
  var sheetDBData = {
    ...
    quantity: "1",
    price: pack,
    product_notice: "Have already an account ? :" + question,
    notice: "",
    status: "pending",
    fees_shipping: "",
  };
    ...
    .then(function (response) {
      ...
      if (response.ok) {
        ...
        fbq("track", "Purchase", {
          value: 10,
          currency: "USD",
          content_name: "Canva consultation",
          content_type: "home decoration",
          product_id: "1133",
        });

        // document.location.href = "/canva_pro/order_success.html";
