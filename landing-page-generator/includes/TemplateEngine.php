    ...
    private function copyAssets($projectDir) {
        ...
        foreach ($filesToCopy as $file) {
            ...
            if (file_exists($sourceFile)) {
                copy($sourceFile, "{$projectDir}/{$file}");
            }
        }

        // Copy pages directory
        $pagesDir = $projectDir . '/pages';
        $templatePagesDir = $templateDir . '/pages';
        if (file_exists($templatePagesDir)) {
            $this->copyDirectory($templatePagesDir, $pagesDir);
        }

        // Copy clients_reviews directory
        $reviewsDir = $projectDir . '/clients_reviews';
        $templateReviewsDir = $templateDir . '/clients_reviews';
